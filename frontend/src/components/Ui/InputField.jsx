...
const InputField = ({value, onChange, title, type, id, placeholder, className=''}) => {
    ...
    return (
        <>
            ...
            <input id={id} type={type} placeholder={placeholder} className={inputClass} value={value} onChange={onChange}/>
        </>
    );
};
