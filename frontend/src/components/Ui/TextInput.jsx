...
const TextInput = ({value, onChange, title, id, placeholder, className=''}) => {
    ...
    return (
        <>
            ...
            <textarea id={id} placeholder={placeholder} className={inputClass} value={value} onChange={onChange}/>
        </>
    );
};
