...
const ReportCard = ({item}) => {
    return (
        <NavLink to={`/dashboard-tutor/reports/${item.id}`} className="flex gap-2 w-100 bg-white/80 drop-shadow-md shadow-gray-300/100 p-5 transition duration-300 hover:scale-103">
