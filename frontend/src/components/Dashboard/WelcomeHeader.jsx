...
const WelcomeHeader = () => {
    ...
    return (
        <div className="ml-2 md:ml-10">
            <h1 className="gradient-text drop-shadow-2xl drop-shadow-secondary text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight">
                Cześć, {name}
            </h1>
            <p className="text-base md:text-xl text-text/70 font-medium">
                Witaj ponownie. Co dzisiaj chcesz zrobić?
            </p>
            {isStudent && <p className="text-xs md:text-sm text-text/70 mt-2">
